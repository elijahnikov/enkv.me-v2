...
export default function Home() {
  ...
  const hour = currentTimeInLondon.split(":")[0];
  const minute = currentTimeInLondon.split(":")[1];
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      <div className="min-h-screen w-[70vw]">
        <div className="flex flex-col -space-y-4 justify-center mt-[24vh] mx-auto items-center text-center">
          <div className="flex items-center text-center space-x-4">
            <p className="tracking-tight text-[54px] text-neutral-400 font-medium">
              Hello 👋🏻, {`I'm`}
            </p>
            <motion.div
            ...
            >
              <Image
                ...
                className="rounded-full ring-[1px] shadow-xl border-[4px] border-white ring-neutral-100"
                alt="headshot"
                sizes="100vw"
                width={120}
                height={120}
          ...
          <div className="flex items-center space-x-4">
            <motion.div
              ...
              transition={{ type: "spring", stiffness: 400, damping: 10 }}
            >
              <div className="ring-[4px] min-w-max shadow-xl min-h-max relative border-[4px] border-white ring-neutral-100 rounded-lg">
                <div>
                  <MousePointer2
                    size={28}
                ...
                <div className="flex justify-between space-x-1">
                  <div className="flex space-x-1">
                    <div className="w-4 h-2 bg-neutral-200 rounded-[2px]" />
                    <div className="w-4 h-2 bg-neutral-200 rounded-[2px]" />
                    <div className="w-4 h-2 bg-neutral-200 rounded-[2px]" />
                  </div>
                  <div className="flex space-x-1">
                    <div className="w-2 h-2 bg-neutral-200 rounded-[2px]" />
                    <div className="w-2 h-2 bg-neutral-200 rounded-[2px]" />
                    <div className="w-2 h-2 bg-neutral-200 rounded-[2px]" />
                  </div>
                </div>
                <div className="flex mt-1 space-x-2">
                  <div className="flex space-x-1">
                    <div className="w-6 h-10 bg-neutral-200 rounded-sm" />
                    <div className="w-16 h-16 bg-neutral-200 rounded-sm" />
                  </div>
                  <div className="flex flex-col space-y-1">
                    <div className="w-8 h-6 bg-neutral-200 rounded-sm" />
                    <div className="w-8 h-6 bg-neutral-200 rounded-sm" />
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col leading-tight -space-y-4">
              ...
              <p className="text-[54px] tracking-tight font-medium">
                developer
              </p>
            </div>
            <p className="text-[54px] mt-6 tracking-tight text-neutral-400 font-medium">
              and
            </p>
            ...
            >
              <div>
                ...
                <Image
                  ...
                  className="ring-[1px] object-cover h-24 w-36 rounded-lg relative shadow-xl border-[4px] border-white ring-neutral-100"
                  alt="headshot"
                  width={140}
                  height={100}
                />
                <p className="mt-2 space-x-2 text-sm font-semibold">
                  <span className="text-neutral-400 font-medium">
                    <NumberTicker value={Number(hour)} />:
                    <NumberTicker value={Number(minute.slice(0, 2))} />
                  </span>
